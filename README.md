...
**PG29 Mobile Development 4**

## About the Project

This project is to create a simple AR prototype using Unity and AR Foundation tools.
...
**Step 1**- Clone the repo to your desktop


**Step 2** - Make sure to have Unity 6.3.8 downloaded


**Step 3** - Add the project from your cloned repo


**Step 4** - If not already downloaded, download Android platform and set it as your current platform.


**Step 5**- Press play to enjoy the game.
